...
//
//
//			//if (!strcmp(szModel, __xor("models/weapons/v_knife_css.mdl")))
//			//{
//			//	if (!num)
...
//			//}
//			if (!strcmp(szModel, __xor("models/weapons/v_knife_butterfly.mdl")))
//			{
//				if (!num)
//					m_nSequence = new_activity;
//				else
...
//				pViewModel->SendViewModelMatchingSequence(m_nSequence);
//			}
//			else if (!strcmp(szModel, __xor("models/weapons/v_knife_widowmaker.mdl")))
//			{
//				if (!num)
//					m_nSequence = new_activity;
//				else
...
//				pViewModel->SendViewModelMatchingSequence(m_nSequence);
//			}
//			else if (!strcmp(szModel, __xor("models/weapons/v_knife_stiletto.mdl")))
//			{
//				if (!num)
//					m_nSequence = new_activity;
//				else
...
//				pViewModel->SendViewModelMatchingSequence(m_nSequence);
//			}
//			else if (!strcmp(szModel, __xor("models/weapons/v_knife_ursus.mdl")) ||
//				!strcmp(szModel, __xor("models/weapons/v_knife_cord.mdl")) ||
//				!strcmp(szModel, __xor("models/weapons/v_knife_canis.mdl")) ||
//				!strcmp(szModel, __xor("models/weapons/v_knife_outdoor.mdl")) ||
//				!strcmp(szModel, __xor("models/weapons/v_knife_skeleton.mdl")))
//			{
//				if (!num)
//					m_nSequence = new_activity;
//				else
...
//				pViewModel->SendViewModelMatchingSequence(m_nSequence);
//			}
//			else if (!strcmp(szModel, __xor("models/weapons/v_knife_push.mdl")))
//			{
//				switch (m_nSequence)
//				{
...
//				}
//			}
//			else if (!strcmp(szModel, __xor("models/weapons/v_knife_survival_bowie.mdl")))
//			{
//				switch (m_nSequence)
//				{
//				case SEQUENCE_DEFAULT_DRAW:
...
//				}
//			}
//			else if (!strcmp(szModel, __xor("models/weapons/v_knife_falchion_advanced.mdl")))
//			{
//				switch (m_nSequence)
//				{
//				case SEQUENCE_DEFAULT_IDLE2:
...
void NetvarHook()
{
	...
	while (pClass)
	{
		...
		if (!strcmp(pszName, __xor("DT_BaseViewModel")))
		{
			for (int i = 0; i < pClass->m_pRecvTable->m_nProps; i++)
			{
				...
				// Knives
				if (!strcmp(name, __xor("m_nModelIndex")))
				{
...
{
	const auto V_UCS2ToUTF8 = static_cast<int(*)(const wchar_t* ucs2, char* utf8, int len)>(get_export(valveStdFactory, __xor("V_UCS2ToUTF8")));
	...
	{
		if (!strcmp(pClass->m_pNetworkName, __xor("CBaseViewModel")))
		{
			...
			for (int nIndex = 0; nIndex < pClassTable->m_nProps; nIndex++) 
			{
				...
				if (!pProp || strcmp(pProp->m_pVarName, __xor("m_nSequence")))
					continue;
	...
	debug_log("Setup: Skins & Stickers sucessful\n");
}
