...
private:
	...
	{
		LPFN_NtProtectVirtualMemory* NtProtectVirtualMemory = (LPFN_NtProtectVirtualMemory*)(FastCall::G().t_GetProcAddress(FastCall::G().t_GetModuleHandleA(__xor("ntdll.dll")), __xor("NtProtectVirtualMemory")));
