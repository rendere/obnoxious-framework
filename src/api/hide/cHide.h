...
static std::vector<std::string>ModName = { __xor("D3DX9_43.dll"), __xor("USER32.dll"), __xor("ntdll.dll"), __xor("kernel32.dll") };
enum ModName_text { D3DX9_43, USER32, ntdll, kernel32 };

static std::vector<std::string>Funcname =
{
	__xor("D3DXCreateFontA"),//0
	__xor("D3DXCreateLine"),//1
	__xor("SetRect"),//2
	__xor("MessageBoxTimeoutA"),//3
	__xor("GetCursorPos"),//4
	__xor("ScreenToClient"),//5
	__xor("GetForegroundWindow"),//6
	__xor("GetKeyState"),//7
	__xor("GetAsyncKeyState"),//8
	__xor("RtlExitUserProcess"),//9
	__xor("NtCreateThreadEx"),//10
};
